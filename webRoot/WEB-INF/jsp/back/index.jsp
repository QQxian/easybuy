...
<body>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="backSp/commodity.do" data-title="商品详情"
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="settlement1.do" data-title="订单详情"
						href="javascript:void(0)">订单详情</a></li>
				</ul>
			</dd>
		</dl>
	</div>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript"
		src="statics/back/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
	<script type="text/javascript">
		$(function() {
