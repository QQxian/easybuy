...
<%@ include file="/WEB-INF/jsp/common/pre/header.jsp" %>
    <title>易买网</title>
		...
		<div class="i_car">
			...
			<div class="car_bg">
				...
				<ul class="cars">
					<li>
						<div class="img">
							<a href="#"><img src="statics/images/car1.jpg" width="58" height="58" /></a>
						</div>
						<div class="name">
					...
					<li>
						<div class="img">
							<a href="#"><img src="statics/images/car2.jpg" width="58" height="58" /></a>
						</div>
						<div class="name">
						...
						<c:forEach items="${newsDetail1}" var="news">
							...
							<li>
								...
								<div class="zj" style="top:-<%=(bb = bb + 40)%>px">
										...
										<div class="zj_l_c">
													...
													<c:forEach items="${newsDetail3}" var="parm">
														<c:if test="${parm.parentid==xo.id}">
															<a href="chakan.do?name=${parm.name}" style="padding: 0;">
																${parm.name}|</a>
														</c:if>
													</c:forEach>
									...
									<div class="zj_r">
										<a href="#"><img src="statics/images/n_img1.jpg" width="236"
											height="200" /></a> <a href="#"><img src="statics/images/n_img2.jpg"
	...
	<div class="i_bg bg_color">
							...
							<div id="botton-scroll">
								<ul class="featureUL">
									<li class="featureBox">
										<div class="box">
											<div class="h_icon">
												<img src="statics/images/hot.png" width="50" height="50" />
											</div>
											<div class="imgbg">
		...
		<div class="content">
			<div class="i_sell">
				<div id="imgPlay">
					<ul class="imgs" id="actor">
						<li><a href="#"><img src="statics/images/tm_r.jpg" width="211"
								height="357" /></a></li>
						<li><a href="#"><img src="statics/images/tm_r.jpg" width="211"
								height="357" /></a></li>
						<li><a href="#"><img src="statics/images/tm_r.jpg" width="211"
			...
			<div class="sell_right">
				<div class="sell_1">
					<div class="s_img">
						<a href="#"><img src="statics/images/tm_1.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>89</span>
				...
				<div class="sell_2">
					<div class="s_img">
						<a href="#"><img src="statics/images/tm_2.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_b1">
					<div class="sb_img">
						<a href="#"><img src="statics/images/tm_b1.jpg" width="242"
							height="356" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_3">
					<div class="s_img">
						<a href="#"><img src="statics/images/tm_3.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_4">
					<div class="s_img">
						<a href="#"><img src="statics/images/tm_4.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_b2">
					<div class="sb_img">
						<a href="#"><img src="statics/images/tm_b2.jpg" width="242"
							height="356" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
		...
		<%
			int c = 0;
		%>
		<c:forEach items="${newsDetail1}" var="news2">
			<div class="i_t mar_10">
				<span class="floor_num"><%=(c = c + 1)%>F</span> <span class="fl">${news2.name}
				</span>
			</div>
			<div class="content">
				<div class="fresh_left">
					<div class="fre_ban">
						<div id="imgPlay1">
							<ul class="imgs" id="actor1">
								<li><a href="#"><img src="statics/images/fre_r.jpg" width="211"
										height="286" /></a></li>
								<li><a href="#"><img src="statics/images/fre_r.jpg" width="211"
										height="286" /></a></li>
								<li><a href="#"><img src="statics/images/fre_r.jpg" width="211"
					...
					<div class="fresh_txt">
						...
						<c:forEach items="${newsDetail2}" var="xo">
								<c:if test="${xo.parentid==news2.id}">
									<a href="chakan.do?categorylevel2id=${xo.id}">${xo.name}</a>
								</c:if>
							</c:forEach>
						</div>
					</div>
				...
				<div class="fresh_mid">
					...
					<ul>
					<c:forEach items="${newsDetai}" var="nnn">
						
							<c:if test="${nnn.categorylevel1id==news2.id}">
								<li>
									<div class="name">
										<a href="#">${nnn.name}</a>
									</div>
									<div class="price">
										<font>￥<span>${nnn.price }</span></font>
									</div>
									<div class="img">
										<a href="#">
											 <img src="<%=rootPath %>/${nnn.filename }"
				...
				<div class="fresh_right">
					<ul>
						<li><a href="#"><img src="statics/images/fre_b1.jpg" width="260"
								height="220" /></a></li>
						<li><a href="#"><img src="statics/images/fre_b2.jpg" width="260"
								height="220" /></a></li>
					</ul>
		...
		<div class="b_nav">
			...
			<div class="b_er">
				<div class="b_er_c">
					<img src="statics/images/er.gif" width="118" height="118" />
				</div>
