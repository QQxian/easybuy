...
<%
	...
	String action=path.substring((path.indexOf("/easybuy/")+9), path.length());
 %>
...
<script type="text/javascript">
  var contextPath = "${ctx}";
    ...
    <script type="text/javascript" src="${ctx}/statics/js/common/shade.js">
    </script>
...
<div class="soubg">
	<div class="sou">
       ...
       <span class="fr">
          ...
          <c:if test="${sessionScope.loginUser!=null}">
            <span class="fl">你好<a href="${ctx}/admin/user?action=index">${sessionScope.loginUser.loginname}</a>&nbsp;|&nbsp;<a href="${ctx}/shopping_Cart.do?action=index&userId=${sessionScope.loginUser.id}">我的订单</a>&nbsp;</span>
          </c:if>
...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <c:forEach items = "${list}" var = "easybuyOrderDetail">
	          <tr class="car_tr t${easybuyOrderDetail.id}">
	            <td>
	            	<div class="c_s_img"><img src="${ctx}/files/${easybuyOrderDetail.cart.fileName}" width="73" height="73" /></div>	          		
	          		<div style="color:red">${easybuyOrderDetail.cart.name }</div>
	          		<input type="hidden" id="userI" value="${easybuyOrderDetail.userI}" />
	            </td>
	            <td align="center">颜色：灰色</td>
	            <td align="center">
	            	<div class="c_num">
	            		<input type="hidden" value="${easybuyOrderDetail.id}" />
	            		<input type="hidden" value="${easybuyOrderDetail.cart.price}"/>
	                    <input type="button" value="" class="car_btn_1" />
	                	<input type="text"  id="zhi" value="${easybuyOrderDetail.quantity}" name="" class="car_ipt" readonly="readonly" />        	
	                    <input type="button"  value=""   class="car_btn_2" />
	                </div>
	            </td>
	            <td align="center" id="xiaoji" style="color:#ff4e00;">￥${easybuyOrderDetail.cost}</td>
	            <td align="center">26R</td>
	            <td align="center"><a href = "javascript:del(${easybuyOrderDetail.id })">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
	          </tr>  
          </c:forEach>
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
            	<label class="r_rad"><input type="checkbox" name="clear" checked="checked" /></label><label class="r_txt">清空购物车</label>
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥<span id="span">2899</span></b></span>
            </td>
          </tr>
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="#"><img src="${ctx}/statics/images/buy1.gif" /></a>&nbsp; &nbsp; <a href="#" id="car2"><img src="${ctx}/statics/images/buy2.gif"/></a>
            </td>
          </tr>
        </table>
    ...
    <!--End Footer End -->    
  	...
  	<script type="text/javascript" src = "${ctx}/statics/js/common/jquery-3.3.1.min.js"></script>
	<script type="text/javascript">
	 $(document).ready(function () {
			var s=0;
	 		$(".car_ipt").each(function(){
				...
				s=s+sum;
				$(this).parent().parent().next().html("￥"+sum.toFixed(1)); 	 			
	 		})
	 		 $("#span").html(s.toFixed(1))
	 })
...
                  		   })
    	...
    	$(".car_btn_1").click(
    			...
    			$(this).parent().parent().next().html("￥"+cost); 
    			
    			var sum=0;
		        $(".car_btn_1").each(function () {
		            var b=$(this).parent().parent().next().html();
		            var c=b.substring(1,b.length);
		            sum=(Number(sum)+Number(c)).toFixed(1);
		        })
		        $("#span").html(sum)
...
                            type:'post',
                            url:"up.do",
                            data:{"quantity":quantity,"cost":cost,"id":id},
                            dataType:'JSON',
