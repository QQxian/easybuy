...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="${easybuyProduct.filename}" title="Images" class="MagicZoom" id="MagicZoom"><img src="files/${easybuyProduct.filename}" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon">
                    <ul>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img src="files/${easybuyProduct.filename}" tsImgS="${ctx}/statics/images/ps1.jpg" width="79" height="79" /></li>
...
<%--             <img class="MagicZoomLoading" width="16" height="16" src="${ctx}/statics/images/loading.gif" alt="Loading..." />				 --%>
        ...
        <div class="pro_des">
        	<div class="des_name">
            	<p>${easybuyProduct.name}</p>
                “开业巨惠，北京专柜直供”，不光低价，“真”才靠谱！
            </div>
            <div class="des_price">
            	本店价格：<b>￥${easybuyProduct.price}</b><br />
                消费积分：<span>28R</span>
            </div>
...
<script src="statices/js/ShopShow.js"></script>
